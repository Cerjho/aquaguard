...
1. `docs/REPO_STRUCTURE.md` — know where every file lives
1. `docs/TECH_STACK_LOCK.md` — know the exact versions and compatibility notes
1. `docs/IMPLEMENTATION_PLAN.md` — know the full build instructions
1. `docs/TASK_BREAKDOWN.md` — know which specific tasks belong to your scope
1. `docs/GIT_WORKFLOW.md` — know the branching strategy, commit format, and
   PR process
1. `docs/VS_CODE_SETUP.md` — know the development environment and tooling
...
|Agent 5 — Testing|`scripts/` (except `test_mqtt.py`)|Application source files|
...
# CORRECT — resolve absolute path using **file** in main.py
