...
class ContinuousFrameWriter:
    ...
    def start(self) -> None:
        ...
        self._thread.start()
        logger.info("[%s] Continuous frame writer started @ %d FPS", self.zone_id, self.target_fps)
    ...
    def stop(self) -> None:
        ...
        logger.info("[%s] Frame writer stopped (%d frames written)", self.zone_id, self._write_count)
