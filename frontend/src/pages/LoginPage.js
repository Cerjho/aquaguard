            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  className="w-full px-4 py-2.5 pr-12 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-slate-800 placeholder-slate-400 disabled:bg-slate-100"
                ...
                <button
                  ...
                  disabled={loading}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus:outline-none focus:text-slate-600 disabled:opacity-60 disabled:cursor-not-allowed"
